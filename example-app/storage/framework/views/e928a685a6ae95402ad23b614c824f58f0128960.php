...
<body>
    ...
    <div class="overview">
        <div class="metric">
            ...
            <p id="correct-questions"><?php echo e($data['totalSchools']); ?></p> <!-- Laravel: Display count of correctly answered questions -->
        </div>
        <div class="metric">
            <h3>Total Participants</h3>
            <p id="correct-questions"><?php echo e($data['totalParticipants']); ?></p> <!-- Laravel: Display count of correctly answered questions -->
        </div>
    ...
    <script>
        ...
        const sch = <?php echo json_encode($schools, 15, 512) ?>;
